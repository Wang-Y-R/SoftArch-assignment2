...
public class KnowledgeBase {
    ...
    private static final String ADD_METHODOLOGY = """
            ...
            ##Step 5 Instantiate Architectural Elements, Allocate Responsibilities, and Define Interfaces: This step requires instantiating architectural elements based on the selected design concepts and assigning responsibilities to them. In addition, relationships and interfaces between elements need to be established so that they can collaborate and exchange information effectively.
            ##Step 6 Sketch Views and Record Design Decisions: At this point, you have completed the design activities for the iteration. In addition to preserving the views—the representations of the structures you created, you should also record the significant decisions made during the design iteration, as well as the reasons behind those decisions (i.e., the rationale), to facilitate later analysis and understanding.
            ##Step 7 Perform Analysis of Current Design and Review Iteration Goal and Achievement of Design Purpose: This step checks whether a partial design that satisfies the goals of the current iteration has been created, and considers whether additional design iterations are needed.
            """;
